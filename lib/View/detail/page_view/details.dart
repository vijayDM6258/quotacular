...
class _DetailPageState extends State<DetailPage>
  ...
  Widget build(BuildContext context) {
    ...
    bool isFavorite = quoteController.favoriteQuotes
        .contains(quoteController.quotes[quoteIndex]);
      ...
      body: Stack(
        children: [
          Container(
            ...
            child: Image.asset("assets/images/detail_bg.png",
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            if (isFavorite) {
                              quoteController.favoriteQuotes
                                  .remove(quoteController.quotes[quoteIndex]);
                            } else {
                    ...
                    Wrap(
                      spacing: 8.0,
                      runSpacing: 4.0,
                      children: quoteController.quotes[quoteIndex]['tags']
                          .map<Widget>((tag) => Chip(
                                label: Text(
                                  tag,
                                  style: GoogleFonts.poppins(),
